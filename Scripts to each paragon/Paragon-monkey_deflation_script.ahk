...
StartDeflation(){
    ...
    ; To pick another map, use the PickMap() function where you gave a page number starting from one
    ; Example would picking a map on the 5 page look like this
    ; ToPage(6) ; Flips to page 6
    ; PickMap(3) ; Pick map 3
...
Monkey(){
    ...
    ; Example on how you would place to monkeys
    ; PlaceMonkey("A", 500, 500, 3, 0, 2)
    ; PlaceMonkey("A", 550, 550, 0, 2, 2)
